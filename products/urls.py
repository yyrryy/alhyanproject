...
urlpatterns = [
    ...
    path('firstcompanyhome', checkviews.firstcompanyhome, name='firstcompanyhome'),
    ...
    path('secondcompanyhome', checkviews.secondcompanyhome, name='secondcompanyhome'),
    ...
    path('commandepdctsecondcompany', checkviews.commandepdctsecondcompany, name='commandepdctsecondcompany'),
    path('cancelcommandsecondcompany', checkviews.cancelcommandsecondcompany, name='cancelcommandsecondcompany'),
